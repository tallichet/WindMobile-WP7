...
namespace CustomControls.Graph
{
    /// <summary>
    ...
    /// </summary>
    public partial class TouchGraph : UserControl
    {
        /// <summary>
        ...
        public static readonly DependencyProperty ChartTitleProperty      = DependencyProperty.Register("ChartTitle",      typeof(string),           typeof(TouchGraph), null);
        public static readonly DependencyProperty DarkAccentColorProperty = DependencyProperty.Register("DarkAccentColor", typeof(Color),            typeof(TouchGraph), null);
        public static readonly DependencyProperty AccentColorProperty     = DependencyProperty.Register("AccentColor",     typeof(Color),            typeof(TouchGraph), null);
        public static readonly DependencyProperty GraphDataProperty       = DependencyProperty.Register("GraphData",       typeof(List<IGraphData>), typeof(TouchGraph), new PropertyMetadata(null, OnGraphDataChanged));
        ...
        public TouchGraph()
        {
            ...
            DarkAccentColor    = (Color)Application.Current.Resources["PhoneBackgroundColor"];
        ...
        protected override void OnManipulationDelta(ManipulationDeltaEventArgs e)
        {
            ...
            PageOrientation orientation = (Application.Current.RootVisual as PhoneApplicationFrame).Orientation;
        ...
        private void CreateGraph()
        {
            ...
            if (!lineGraph)
            {
                ...
                {
                    Stroke = (SolidColorBrush)Application.Current.Resources["PhoneBorderBrush"],
                    Fill   = this.fillBrush,
                    StrokeThickness = 0
                };
            }
